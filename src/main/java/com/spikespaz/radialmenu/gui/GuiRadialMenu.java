...
public class GuiRadialMenu extends GuiScreen {
    ...
    private GuiRadialButton addButton(int id, int circleRadius, int deadZoneRadius, int buttonThickness, int buttonBgColor, int buttonBgHoverColor, int showDuration, int hoverDuration, GuiRadialButton.FadeMode showFadeMode, GuiRadialButton.FadeMode hoverFadeMode) {
        GuiRadialButton button = this.addButton(new GuiRadialButton(id, circleRadius, deadZoneRadius, buttonThickness, buttonBgColor, buttonBgHoverColor, showDuration, hoverDuration, showFadeMode, hoverFadeMode));
